...
--
-- Servidor: db5013050230.hosting-data.io
-- Tiempo de generación: 17-10-2023 a las 18:41:36
...
--
-- Estructura Stand-in para la vista `customer_product_dollarsales`
...
--
-- Estructura de tabla para la tabla `kac_tbkeywords`
--
...
--
-- Volcado de datos para la tabla `kac_tbkeywords`
--
...
--
-- Estructura de tabla para la tabla `kcb_tbcities`
--
...
--
-- Volcado de datos para la tabla `kcb_tbcities`
--
...
--
-- Estructura de tabla para la tabla `kcb_tbcontinents`
--
...
--
-- Volcado de datos para la tabla `kcb_tbcontinents`
--
...
--
-- Estructura de tabla para la tabla `kcb_tbcountries`
--
...
--
-- Volcado de datos para la tabla `kcb_tbcountries`
--
...
--
-- Estructura de tabla para la tabla `kcb_tbstates`
--
...
--
-- Volcado de datos para la tabla `kcb_tbstates`
--
...
--
-- Estructura de tabla para la tabla `tbtreeviewdata`
--
...
--
-- Volcado de datos para la tabla `tbtreeviewdata`
--
...
--
-- Estructura de tabla para la tabla `tb_imageview`
--
...
--
-- Volcado de datos para la tabla `tb_imageview`
--
...
--
-- Estructura de tabla para la tabla `tb_slidemenu`
--
...
--
-- Volcado de datos para la tabla `tb_slidemenu`
--
...
(1, 'demo', 'demo'),
(4, 'arturo', 'Quetecalles');

-- --------------------------------------------------------

--
-- Estructura para la vista `customer_product_dollarsales`
--
DROP TABLE IF EXISTS `customer_product_dollarsales`;

CREATE ALGORITHM=UNDEFINED DEFINER=`o10957667`@`%` SQL SECURITY DEFINER VIEW `customer_product_dollarsales`  AS SELECT `customers`.`customerName` AS `customerName`, `products`.`productName` AS `productName`, `products`.`productLine` AS `productLine`, `orderdetails`.`quantityOrdered`* `orderdetails`.`priceEach` AS `dollar_sales` FROM (((`customers` join `orders`) join `orderdetails`) join `products`) WHERE `orders`.`customerNumber` = `customers`.`customerNumber` AND `orders`.`orderNumber` = `orderdetails`.`orderNumber` AND `products`.`productCode` = `orderdetails`.`productCode``productCode` ;
...
--
-- Indices de la tabla `kcb_tbcities`
--
ALTER TABLE `kcb_tbcities`
  ADD PRIMARY KEY (`CityID`);

--
-- Indices de la tabla `kcb_tbcontinents`
--
ALTER TABLE `kcb_tbcontinents`
  ADD PRIMARY KEY (`ContinentID`);

--
-- Indices de la tabla `kcb_tbcountries`
--
ALTER TABLE `kcb_tbcountries`
  ADD PRIMARY KEY (`CountryID`);

--
-- Indices de la tabla `kcb_tbstates`
--
...
--
-- Indices de la tabla `tbtreeviewdata`
--
ALTER TABLE `tbtreeviewdata`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tb_imageview`
--
ALTER TABLE `tb_imageview`
  ADD KEY `ID` (`ID`);

--
-- Indices de la tabla `tb_slidemenu`
--
