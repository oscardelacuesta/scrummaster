...
-- Volcando estructura de base de datos para scrum4master
CREATE DATABASE IF NOT EXISTS `scrum4master` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `scrum4master`;

-- Volcando estructura para tabla scrum4master.Backlog-PilaDeProducto
CREATE TABLE IF NOT EXISTS `Backlog-PilaDeProducto` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Backlog-PilaDeProducto: ~0 rows (aproximadamente)
DELETE FROM `Backlog-PilaDeProducto`;

-- Volcando estructura para tabla scrum4master.Companeros
CREATE TABLE IF NOT EXISTS `Companeros` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Companeros: ~0 rows (aproximadamente)
DELETE FROM `Companeros`;

-- Volcando estructura para tabla scrum4master.customers
...
-- Volcando datos para la tabla scrum4master.customers: ~122 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.Daily-Scrum
CREATE TABLE IF NOT EXISTS `Daily-Scrum` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Daily-Scrum: ~0 rows (aproximadamente)
DELETE FROM `Daily-Scrum`;

-- Volcando estructura para tabla scrum4master.DailyScrum
CREATE TABLE IF NOT EXISTS `DailyScrum` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.DailyScrum: ~0 rows (aproximadamente)
DELETE FROM `DailyScrum`;

-- Volcando estructura para tabla scrum4master.employees
...
-- Volcando datos para la tabla scrum4master.employees: ~23 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.Equipo
CREATE TABLE IF NOT EXISTS `Equipo` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Equipo: ~0 rows (aproximadamente)
DELETE FROM `Equipo`;

-- Volcando estructura para tabla scrum4master.Equipos-Implicados
CREATE TABLE IF NOT EXISTS `Equipos-Implicados` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Equipos-Implicados: ~0 rows (aproximadamente)
DELETE FROM `Equipos-Implicados`;

-- Volcando estructura para tabla scrum4master.kac_tbkeywords
CREATE TABLE IF NOT EXISTS `kac_tbkeywords` (
  `KeyWord` varchar(100) DEFAULT NULL,
  `ResultNo` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;

-- Volcando datos para la tabla scrum4master.kac_tbkeywords: ~249 rows (aproximadamente)
DELETE FROM `kac_tbkeywords`;
...
-- Volcando estructura para tabla scrum4master.kcb_tbcities
...
-- Volcando datos para la tabla scrum4master.kcb_tbcities: ~25 rows (aproximadamente)
DELETE FROM `kcb_tbcities`;
...
-- Volcando estructura para tabla scrum4master.kcb_tbcontinents
CREATE TABLE IF NOT EXISTS `kcb_tbcontinents` (
  `ContinentID` int(11) NOT NULL,
  `ContinentName` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;

-- Volcando datos para la tabla scrum4master.kcb_tbcontinents: ~6 rows (aproximadamente)
DELETE FROM `kcb_tbcontinents`;
...
-- Volcando estructura para tabla scrum4master.kcb_tbcountries
...
-- Volcando datos para la tabla scrum4master.kcb_tbcountries: ~230 rows (aproximadamente)
DELETE FROM `kcb_tbcountries`;
...
-- Volcando estructura para tabla scrum4master.kcb_tbstates
...
-- Volcando datos para la tabla scrum4master.kcb_tbstates: ~50 rows (aproximadamente)
DELETE FROM `kcb_tbstates`;
...
-- Volcando estructura para tabla scrum4master.offices
...
-- Volcando datos para la tabla scrum4master.offices: ~7 rows (aproximadamente)
DELETE FROM `offices`;
...
-- Volcando estructura para tabla scrum4master.orderdetails
...
-- Volcando datos para la tabla scrum4master.orderdetails: ~2.996 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.orders
...
-- Volcando datos para la tabla scrum4master.orders: ~324 rows (aproximadamente)
DELETE FROM `orders`;
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `attachedfiles`) VALUES
	(10101, '2003-01-09 00:00:00', '2003-01-18 00:00:00', '2003-01-11 00:00:00', 'Shipped', '', 128, NULL),
	...
	(10161, '2003-10-17 00:00:00', '2003-10-25 00:00:00', '2003-10-20 00:00:00', 'Shipped', '', 227, NULL),
...
-- Volcando estructura para tabla scrum4master.payments
...
-- Volcando datos para la tabla scrum4master.payments: ~273 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.productlines
...
-- Volcando datos para la tabla scrum4master.productlines: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.ProductOwner
CREATE TABLE IF NOT EXISTS `ProductOwner` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.ProductOwner: ~0 rows (aproximadamente)
DELETE FROM `ProductOwner`;

-- Volcando estructura para tabla scrum4master.products
...
-- Volcando datos para la tabla scrum4master.products: ~110 rows (aproximadamente)
...
-- Volcando estructura para tabla scrum4master.Proyectos
CREATE TABLE IF NOT EXISTS `Proyectos` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Proyectos: ~0 rows (aproximadamente)
DELETE FROM `Proyectos`;

-- Volcando estructura para tabla scrum4master.Scrum-De-Scrum
CREATE TABLE IF NOT EXISTS `Scrum-De-Scrum` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Scrum-De-Scrum: ~0 rows (aproximadamente)
DELETE FROM `Scrum-De-Scrum`;

-- Volcando estructura para tabla scrum4master.Skateholder
CREATE TABLE IF NOT EXISTS `Skateholder` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Skateholder: ~1 rows (aproximadamente)
DELETE FROM `Skateholder`;
INSERT INTO `Skateholder` (`ID`, `Nombre`) VALUES
	(1, 'Oscar');

-- Volcando estructura para tabla scrum4master.Sprint
CREATE TABLE IF NOT EXISTS `Sprint` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Sprint: ~0 rows (aproximadamente)
DELETE FROM `Sprint`;

-- Volcando estructura para tabla scrum4master.Sprint-Review-Meeting
CREATE TABLE IF NOT EXISTS `Sprint-Review-Meeting` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Sprint-Review-Meeting: ~0 rows (aproximadamente)
DELETE FROM `Sprint-Review-Meeting`;

-- Volcando estructura para tabla scrum4master.Tareas-Sprint
CREATE TABLE IF NOT EXISTS `Tareas-Sprint` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  KEY `ID` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- Volcando datos para la tabla scrum4master.Tareas-Sprint: ~0 rows (aproximadamente)
DELETE FROM `Tareas-Sprint`;

-- Volcando estructura para tabla scrum4master.tbtreeviewdata
...
-- Volcando datos para la tabla scrum4master.tbtreeviewdata: ~10 rows (aproximadamente)
DELETE FROM `tbtreeviewdata`;
...
-- Volcando estructura para tabla scrum4master.tb_imageview
...
-- Volcando datos para la tabla scrum4master.tb_imageview: ~6 rows (aproximadamente)
DELETE FROM `tb_imageview`;
...
-- Volcando estructura para tabla scrum4master.tb_slidemenu
...
-- Volcando datos para la tabla scrum4master.tb_slidemenu: ~27 rows (aproximadamente)
DELETE FROM `tb_slidemenu`;
...
-- Volcando estructura para tabla scrum4master.usuarios
...
-- Volcando datos para la tabla scrum4master.usuarios: ~2 rows (aproximadamente)
